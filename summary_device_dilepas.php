...
<body>
  ...
  <div class="container">
    <div class="summary-container-title justify-content-center align-items-center">
      <br><h2 style="font-size: 40px">Summary Device Removed</h2><br><br>
    </div>
    <?php
      include 'config.php';

      $sql = "SELECT d.nama, d.komoditi, d.jenis, d.waktuupdate AS waktu_update, d.tanggalupdate AS tanggal_update, d.ket, d.tanggal, d.waktu, d.stasiun FROM device_data d WHERE `kondisi` LIKE 'dilepas'";
      ...
      <div class="summary-item komoditi">
        ...
        <div class="komoditi-type">
          <?php
            ...
            $sql = "SELECT komoditi FROM device_data WHERE `kondisi` LIKE 'dilepas'";
            $result = $conn->query($sql);
      ...
      <div class="summary-item jenis-tanah">
        ...
        <div class="jenis-tanah-type">
          <?php
            ...
            $sql = "SELECT jenis FROM device_data WHERE `kondisi` LIKE 'dilepas'";
            $result = $conn->query($sql);
  ...
  <div class="button-container text-center">
      <a href="summary_device_dipasang.php" class="btn btn-primary mx-2">Summary Device Installed</a>
...
<!--          <th>Waktu Update</th>-->
      ...
      <tbody id="tableBody">
        <?php
          ...
          $sql = "SELECT d.nama, d.komoditi, d.jenis, d.iddevice, d.wilayah, d.waktuupdate AS waktu_update, d.tanggalupdate AS tanggal_update, d.ket, d.tanggal, d.waktu, d.stasiun, d.kondisi FROM device_data d WHERE `kondisi` LIKE 'dilepas'";
          $result = $conn->query($sql);
