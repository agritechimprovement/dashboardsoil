...
<body>
  ...
  <div class="container">
    <div class="summary-container-title justify-content-center align-items-center">
      <br><h2 style="font-size: 40px">Summary Total Device</h2><br><br>
    </div>
    <?php
      include 'config.php';
    ...
    <div class="summary-container-title justify-content-center align-items-center">
      <br><h2>Summary Device Non-Aktif</h2>
    </div>
    <div class="summary-container">
      <div class="summary-item komoditi">
        <h3>Komoditi</h3>
  ...
  <div class="button-container text-center">
      <a href="summary_device_dipasang.php" class="btn btn-primary mx-2">Summary Device Dipasang</a>
    ...
    <table id="customerTable" class="display">
      ...
      <tbody id="tableBody">
        <?php
          ...
          $sql = "SELECT d.nama, d.komoditi, d.jenis, d.iddevice, d.wilayah, d.waktuupdate AS waktu_update, d.tanggalupdate AS tanggal_update, d.ket, d.tanggal, d.waktu, d.stasiun, d.kondisi FROM device_data d";
          $result = $conn->query($sql);
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>
                  <a class='btn btn-primary' href='view_history.php?nama=" . $row["nama"] . "'>Lihat</a>
                  </td>";
                  echo "</tr>";
              }
          } else {
